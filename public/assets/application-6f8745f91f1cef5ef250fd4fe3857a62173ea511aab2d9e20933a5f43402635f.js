...
//green3: #407132
	...
	$("#path42, #g9").on("mouseover", function() {
    	$("#path42").css({fill: "#2fd13e", transition: ".5"});
    	$("#path40").css({fill: "#407132", transition: ".5s"});
    	$("#path38").css({fill: "#269630", transition: ".5s"});
	}).on("mouseout", function() {
	...
	$("#path40, #g25").on("mouseover", function() {
...
$(document).ready(function(){
	...
	var getLookup = function(){
		...
		var google = "";
		var sunlight = "0b6a2cec0fa54bd0ae0816a53afb82cf";
